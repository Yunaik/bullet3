...
extern "C"
{
    ...
    // Add by syslot
	B3_SHARED_API int b3GetJointStatePhysX(b3PhysicsClientHandle physClient, b3SharedMemoryStatusHandle statusHandle, int jointIndex, struct b3JointSensorState* state);
