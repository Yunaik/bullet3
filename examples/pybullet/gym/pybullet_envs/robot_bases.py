...
class XmlBasedRobot:
    ...
    def addToScene(self, bullet_client, bodies):
        ...
        # print("NUm joints: ", self._p.getNumJoints(bodies[0]))
...
class MJCFBasedRobot(XmlBasedRobot):
    ...
    def __init__(self,  model_xml, robot_name, action_dim, obs_dim, self_collision=True, isPhysx=False):
...
class URDFBasedRobot(XmlBasedRobot):
    ...
    def __init__(self, model_urdf, robot_name, action_dim, obs_dim, basePosition=[0, 0, 0], baseOrientation=[0, 0, 0, 1], fixed_base=False, self_collision=False, isPhysx=False, robot_setup=None):
        XmlBasedRobot.__init__(self, robot_name, action_dim, obs_dim, self_collision, isPhysx=isPhysx)
...
class Joint:
    ...
    def reset_position(self, position, velocity):
        ...
        # print("JointIndex: ", self.jointIndex)
        # print("BodyIndex: ", self.bodyIndex)
